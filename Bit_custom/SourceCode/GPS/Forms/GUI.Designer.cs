...
namespace AgOpenGPS
{
    public partial class FormGPS
    {
        ...
        private void resize_icon()
        {
            int diviser = 9;
            if (oglMain.Height < 750)
            {
                btnContourPriority.Height = oglMain.Height / diviser;
                btnContour.Height = oglMain.Height / diviser;

                btnTramMenu.Height = oglMain.Height / diviser;
                btnTramMenu.Top = btnContourPriority.Top + btnContourPriority.Height + 5;
                btnCurve.Height = oglMain.Height / diviser;
                btnCurve.Top = btnContourPriority.Top + btnContourPriority.Height + 5;

                btnEditHeadingB.Height = oglMain.Height / diviser;
                btnEditHeadingB.Top = btnTramMenu.Top + btnTramMenu.Height + 5;
                btnABLine.Height = oglMain.Height / diviser;
                btnABLine.Top = btnTramMenu.Top + btnTramMenu.Height + 5;

                btnMakeLinesFromBoundary.Height = oglMain.Height / diviser;
                btnMakeLinesFromBoundary.Top = btnEditHeadingB.Top + btnEditHeadingB.Height + 5;
                btnCycleLines.Height = oglMain.Height / diviser;
                btnCycleLines.Top = btnEditHeadingB.Top + btnEditHeadingB.Height + 5;

                cboxpRowWidth.Height = oglMain.Height / diviser - 10;
                cboxpRowWidth.Top = btnMakeLinesFromBoundary.Top + btnMakeLinesFromBoundary.Height + 5;
                btnManualOffOn.Height = oglMain.Height / diviser;
                btnManualOffOn.Top = btnMakeLinesFromBoundary.Top + btnMakeLinesFromBoundary.Height + 5;

                btnFlag.Height = oglMain.Height / diviser;
                btnFlag.Top = btnManualOffOn.Top + btnManualOffOn.Height + 5;
                btnSectionOffAutoOn.Height = oglMain.Height / diviser;
                btnSectionOffAutoOn.Top = btnManualOffOn.Top + btnManualOffOn.Height + 5;

                btnHeadlandOnOff.Height = oglMain.Height / diviser;
                btnHeadlandOnOff.Top = btnFlag.Top + btnFlag.Height + 5;
                btnAutoYouTurn.Height = oglMain.Height / diviser;
                btnAutoYouTurn.Top = btnFlag.Top + btnFlag.Height + 5;

                btnHydLift.Height = oglMain.Height / diviser;
                btnHydLift.Top = btnHeadlandOnOff.Top + btnHeadlandOnOff.Height + 5;
                btnAutoSteer.Height = oglMain.Height / diviser;
                btnAutoSteer.Top = btnHeadlandOnOff.Top + btnHeadlandOnOff.Height + 5;
            }
        }
        ...
        public void SwapBatmanPanels()
        {
            ...
            if (isSimple)
            {
                oglMain.Width = Width - (statusStripLeft.Width);
                if (isFullScreen) oglMain.Width += 20;
                btnContourPriority.Visible = false;
                btnTramMenu.Visible = false;
                btnEditHeadingB.Visible = false;
            ...
            else
            {
                oglMain.Width = Width - (statusStripLeft.Width);
                if (isFullScreen) oglMain.Width += 20;
                btnContourPriority.Visible = true;
                btnTramMenu.Visible = true;
                btnEditHeadingB.Visible = true;
